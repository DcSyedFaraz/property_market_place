                                        ...
                                        <div class="mb-0 border-0">
                                                ...
                                                <div class="text-center">
                                                    <div class="mb-4">
                                                        <a class='auth-logo' href='{{ route('home') }}'>
                                                            <img src="{{ asset('assets/img/logo-footer01.png') }}" alt="logo-dark" class="mx-auto" height="80" />
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="pt-0">
                                                ...
                                                <div class="text-center text-muted">
                                                    <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='/register'>Sign Up</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
