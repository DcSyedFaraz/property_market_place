...
@section('content')
   ...
   <section class="sec-001 bread-crumb">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center">Properties Details</h1>
                <p class="text-center"><a href="index.html">Home</a> / <a href="#">Properties Details</a></p>
            </div>
        </div>
</section>
<!-- Bread Crumb End -->
            ...
            <div class="row mt-4">
                <div class="col-md-8">
                    <div class="properies-detail-colum">
                        ...
                        <h4 class="mt-4">Dubai Hills Estate - 101, Building A, Street 123, Dubai</h4>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum urna vel velit
                            vestibulum, ac sagittis neque consectetur. Sed vel mi lectus. Sed hendrerit, velit vel
                            ullamcorper tincidunt, velit felis tincidunt velit</p>
                        <h4 class="mt-4">Shop Details:</h4>
                        <ul class="property-details">
                            <li>
                                <strong>Unit Area:</strong> 5,063.13 Sq Ft
                            </li>
                            <li>
                                <strong>Balcony Area:</strong> 10,433.20 Sq Ft
                            </li>
                            <li>
                                <strong>Total Area :</strong> 15, 496.37 Sq Ft
                            </li>
                            <li>
                                <strong>Utility Area:</strong> 161.46 Sq Ft
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    <div class="property-box1">
                        <a href="{{ route('property_details') }}"><img src="assets/img/similer-01.png" alt=""></a>
